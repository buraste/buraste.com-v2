...
I update the notes weekly. The content being markdown files found here, which after every commit to the GitHub repo builds the website using Nextra and publishes it to [garden.buraste.com](https://garden.buraste.com) from which you are likely reading this page.
